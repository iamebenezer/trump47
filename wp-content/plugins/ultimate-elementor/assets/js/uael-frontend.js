(function($) {
                    ...
                    if ('yes' == repeat) {
                        if (!elementorFrontend.isEditMode()) {
                            ...
                            function updateSections() {
                                ...
                                if (!(section.offset().top - halfWindowHeight < scrollTop) && (section.offset().top + section.height() - halfWindowHeight > scrollTop)) {} else {
    ...
    var WidgetUAELVideoGalleryHandler = function($scope, $) {
        ...
        if ('carousel' == layout) {
            ...
            if (selector.find('.uael-video__gallery-iframe').imagesLoaded({
                    background: true
                })) {
    ...
    var WidgetUAELImageGalleryHandler = function($scope, $) {
        ...
        if (slider_selector.length > 0) {
            ...
            var adaptiveImageHeight = function(e, obj) {
                ...
                node.find('.slick-list.draggable').animate({
                    height: max_height
                }, {
                    duration: 200,
                    easing: 'linear'
            ...
            if (0 == selector.find('iframe').length) {
                ...
                if (outer_wrap.hasClass('uael-video-type-hosted')) {
                    ...
                    iframe.ready(function() {
                        var hosted_video_iframe = iframe.contents().find('body').css({
                            "margin": "0px"
                        });
